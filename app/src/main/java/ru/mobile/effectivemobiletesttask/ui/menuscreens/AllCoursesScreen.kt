...
fun AllCoursesScreen(viewModel: CoursesViewModel) {
    ...
    Column(Modifier.padding(horizontal = 10.dp).padding(top = 10.dp)) {
        ...
        Row(modifier = Modifier.height(32.dp).align(Alignment.End), verticalAlignment = Alignment.CenterVertically) {
            Text("По дате добавления", color = Color(0xff12B956))
            Spacer(modifier = Modifier.width(3.dp))
            Image(painterResource(R.drawable.img_3), "", modifier = Modifier.fillMaxHeight())
        }

        LazyColumn{
            items(viewModel.mutableLiveData.value?.courses!!){

                Card (modifier = Modifier.padding(top = 10.dp).fillMaxWidth().height((heightScreen*0.330).dp), colors = CardDefaults.cardColors(containerColor = Color(0xff24252A))) {
                    Column {
                        Box(
                            ...
                            Row(Modifier.align(Alignment.BottomStart)) {
                                Box(
                                    ...
                                    Row(
                                        ...
                                        Text(it?.rate.toString(), modifier = Modifier.weight(1f))
                                    }
                                }
                                Box(
                        ...
                        Box(modifier = Modifier.weight(1f)) {
                            Column {
                                ...
                                Row(
                                    ...
                                    Text(
                                        it?.price.toString(),
                                        modifier = Modifier.align(Alignment.Bottom).padding(5.dp),
                                        color = Color.White,
                                        fontSize = 20.sp
                                    )
